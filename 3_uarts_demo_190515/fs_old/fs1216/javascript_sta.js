...
{
  FindAndSelect(document.wifista.wifistasm, stasec);
  //FindAndSelect(document.wifista.wifistaet, staenc);
  FindAndSelect(document.wifista.wifict, stacon);
  //FindAndSelect(document.wifista.wifidt, apdh);
  
  //document.wifista.wifinn.value = apsid;
  //document.wifista.wifimac.value = apmac;
